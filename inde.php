  ...
  <body role="document">
    ...
    <p>
      ...
      <div class="row">
        ...
        <div class="col-md-9">
          <?php
            $sql = 'SELECT listorder, nom, oa.article AS article, prix, img, quantity, stock, objet FROM article a INNER JOIN objetsInArticle oa on a.id=oa.article INNER JOIN objet o on o.id=oa.objet WHERE actif=1 ORDER BY listorder, quantity;'; 
