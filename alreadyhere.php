...
$sql = "SELECT nomclient, emplacement FROM commande WHERE nomclient='$nom' AND datestamp=CURDATE()"; 
...
$sql = "SELECT nomclient, emplacement FROM commande WHERE emplacement='$emplacement' AND datestamp=CURDATE()"; 
