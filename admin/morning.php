          ...
          <table id="main" class="table table-striped">
            ...
            <tbody>
              ...
              foreach ($tab as $name => $data) {
                  ...
                  echo '        <button value="'.$data['order'].'" name='.$data['name'].' pitch='.$data['pitch'].'  type="button" class="btn btn-default redo clicksee" stye="float:left" data-dismiss="modal">Recommander et valider</button>';
                ...
                //Début de autre chose a virer dans 2min
